    ...
    <div className="min-h-screen" style={{ background: 'var(--color-offwhite)' }}>
      <section className="border-b border-white/10 py-14" style={{ background: 'var(--color-teal)' }}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="text-5xl font-bold text-white mb-4">Shipping and Delivery</h1>
        </div>
      </section>

      <div className="max-w-3xl mx-auto px-4 py-16">
        <p className="text-zinc-600 text-lg leading-relaxed mb-8">
          ITS dispatches Australia-wide from our Dandenong South warehouse. Freight rates and delivery times vary by destination and order — contact us for a quote.
        </p>
